...
?>
							...
							<input type="text" name="batch_security_code" id="batch_security_code"/><br /><br />
<?php
endif;
?>
							<label>Your name (optional, for credit/attribution):</label><br />
							<input id="submitter" name="submitter" size="24" maxlength="127" type="text"<?php if( isset( $_SESSION['submitter'] ) and trim( $_SESSION['submitter'] ) ) echo ' value="', sanitise( $_SESSION['submitter'] ), '"'; ?> /><br />
